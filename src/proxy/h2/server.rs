...
impl H2Request {
	...
	pub async fn send_response(self, resp: Response<()>) -> Result<crate::proxy::h2::H2Stream, Error> {
	...
	Fut: Future<Output = ()> + Send + 'static,
{
	...
	tokio::task::spawn(crate::proxy::h2::do_ping_pong(ping_pong, ping_drop_tx, dropped.clone()));
