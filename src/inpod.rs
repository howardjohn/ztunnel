...
pub fn init_and_new(
	...
	let state_mgr = statemanager::WorkloadProxyManagerState::new(proxy_gen, inpod_config, metrics, admin_handler);

	Ok(WorkloadProxyManager::new(cfg.inpod_uds.clone(), state_mgr, ready)?)
}
