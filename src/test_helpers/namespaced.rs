...
pub fn initialize_namespace_tests() {
	...
	mount(Some(&tmp.join("netns")), "/var/run/netns", None::<&PathBuf>, MsFlags::MS_BIND, None::<&PathBuf>)
	...
	mount(Some(&tmp.join("xtables.lock")), "/run/xtables.lock", None::<&PathBuf>, MsFlags::MS_BIND, None::<&PathBuf>)
