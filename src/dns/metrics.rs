...
impl Metrics {
	pub fn new(registry: &mut Registry) -> Self {
		...
		registry.register("dns_requests", "Total number of DNS requests (unstable)", requests.clone());
		...
		Self { requests, forwarded_requests, forwarded_failures, forwarded_duration }
	}
}
